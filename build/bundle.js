...
var d3Sum = function(values, valueof) {
  var n = values.length,
      i = -1,
      value,
      sum = 0;
...
var PearlChart = function (_OECDChart) {
  ...
  createClass(PearlChart, [{
    ...
    value: function render() {
      ...
      this.scale = linear().domain(extent).range([0, innerWidth]);
...
var StackedChart = function (_OECDChart) {
  ...
  createClass(StackedChart, [{
    ...
    value: function render() {
      ...
      this.x = linear().range([0, innerWidth]).domain(extent$$1);
...
var BoxPlot = function (_OECDChart) {
  ...
  createClass(BoxPlot, [{
    ...
    value: function getChart(data) {
      ...
      this.x = linear().range([0, innerWidth - innerMarginRight - innerMarginLeft]).domain(extent);
