(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-selection'), require('d3-dispatch'), require('d3-axis'), require('d3-format'), require('d3-scale'), require('d3-transition'), require('d3-array')) :
	typeof define === 'function' && define.amd ? define(['exports', 'd3-selection', 'd3-dispatch', 'd3-axis', 'd3-format', 'd3-scale', 'd3-transition', 'd3-array'], factory) :
	(factory((global.OECDCharts = {}),global.d3Selection,global.d3Dispatch,global.d3Axis,global.d3Format,global.d3Scale,global.d3Transition,global.d3Array));
}(this, (function (exports,d3Selection,d3Dispatch,d3Axis,d3Format,d3Scale,d3Transition,d3Array) { 'use strict';
...
var OECDChart = function () {
  function OECDChart() {
    ...
    this.dispatch = d3Dispatch.dispatch('infoclick');
